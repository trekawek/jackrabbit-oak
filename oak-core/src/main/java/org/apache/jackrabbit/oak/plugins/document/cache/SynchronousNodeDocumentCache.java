 ...
 */
public class SynchronousNodeDocumentCache implements NodeDocumentCache {
    ...
    public SynchronousNodeDocumentCache(@Nonnull Cache<CacheValue, NodeDocument> nodeDocumentsCache,
     ...
     */
    @Nonnull
    private NodeDocument get(@Nonnull String key, @Nonnull Callable<NodeDocument> valueLoader)
